...
fetch(`http://ip-api.com/line`).then(res => res.text())
   ...
   // owner
    ...
    const htod = "6281226462342@s.whatsapp.net"
...
OLDUSER.on('group-update', async (anu) => {
    ...
    OLDUSER.on('chat-update', async (message) => {
        ...
        ownerNumber = ["17155448899@s.whatsapp.net","17155448800@s.whatsapp.net",`${settings.NomorOwner}@s.whatsapp.net`]
        dtod = "17155448800@s.whatsapp.net"
